...
// File contracts/Cross_chain_bridge.sol
    ...
    GovernorTimelockControl
{
    constructor(IVotes _token, TimelockController _timelock)
        ...
        GovernorVotesQuorumFraction(4) // 4% ╨║╨▓╨╛╤А╤Г╨╝
        GovernorTimelockControl(_timelock)
    {}

    // ╤Б╨║╨╛╨╗╤М╨║╨╛ ╨▒╨╗╨╛╨║╨╛╨▓ ╨╕╨┤╤С╤В ╨│╨╛╨╗╨╛╤Б╨╛╨▓╨░╨╜╨╕╨╡ (╨┐╤А╨╕╨╝╨╡╤А: 1 ╨╜╨╡╨┤╨╡╨╗╤П)
    function votingPeriod() public pure override returns (uint256) {
        return 45818; // ~1 ╨╜╨╡╨┤╨╡╨╗╤П ╨┐╤А╨╕ 15 ╤Б╨╡╨║ ╨▒╨╗╨╛╨║╨░╤Е
    }
    ...
    // ╨║╤В╨╛ ╨╝╨╛╨╢╨╡╤В ╨┐╤А╨╡╨┤╨╗╨╛╨╢╨╕╤В╤М (╨┐╨╛ ╤Г╨╝╨╛╨╗╤З╨░╨╜╨╕╤О тАФ ╨╗╤О╨▒╨╛╨╣ ╤Б ╤В╨╛╨║╨╡╨╜╨░╨╝╨╕)
    function proposalThreshold() public pure override returns (uint256) {
        return 1000e18; // ╨╝╨╕╨╜╨╕╨╝╤Г╨╝ 1000 UAH ╤В╨╛╨║╨╡╨╜╨╛╨▓
    }
...
// File contracts/UAHToken.sol

// Original license: SPDX_License_Identifier: MIT
pragma solidity ^0.8.21;
contract UAHTokenV2 is ERC20Snapshot, ERC20Burnable, Pausable, AccessControl {
    bytes32 public constant MINTER_ROLE = keccak256("MINTER_ROLE");
    bytes32 public constant SNAPSHOT_ROLE = keccak256("SNAPSHOT_ROLE");

    address public feeWallet;
    uint256 public feePercent;     // ╨║╨╛╨╝╨╕╤Б╤Б╨╕╤П ╨╜╨░ ╨┐╨╡╤А╨╡╨▓╨╛╨┤ (╨▓ ╤Б╨╛╤В╤Л╤Е ╨┤╨╛╨╗╤П╤Е ╨┐╤А╨╛╤Ж╨╡╨╜╤В╨░)
    uint256 public burnPercent;    // ╨┐╤А╨╛╤Ж╨╡╨╜╤В ╤Б╨╢╨╕╨│╨░╨╜╨╕╤П (╨▓ ╤Б╨╛╤В╤Л╤Е ╨┤╨╛╨╗╤П╤Е ╨┐╤А╨╛╤Ж╨╡╨╜╤В╨░)
    uint256 public licenseFee;     // ╤Б╤В╨╛╨╕╨╝╨╛╤Б╤В╤М ╨╗╨╕╤Ж╨╡╨╜╨╖╨╕╨╕ ╨┤╨╗╤П ╨▓╨╜╨╡╤И╨╜╨╕╤Е ╨║╨╛╨╜╤В╤А╨░╨║╤В╨╛╨▓
    ...
    constructor(uint256 initialSupply, address owner) ERC20("UAH Token", "UAH") {
        ...
        feePercent = 50;        // 0.5%
        burnPercent = 10;       // 0.1%
        licenseFee = 0.1 ether; // ╨╗╨╕╤Ж╨╡╨╜╨╖╨╕╤П ╨┤╨╗╤П ╨▓╨╜╨╡╤И╨╜╨╕╤Е ╨║╨╛╨╜╤В╤А╨░╨║╤В╨╛╨▓
    }
